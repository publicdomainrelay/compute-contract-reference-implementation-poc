...
const $nsid = 'com.publicdomainrelay.temp.compute.events.vm.started'

export { $nsid }

/** Reports that a provisioned VM has started booting. */
type Main = {
  $type: 'com.publicdomainrelay.temp.compute.events.vm.started'
