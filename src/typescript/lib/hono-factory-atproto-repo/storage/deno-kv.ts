// @publicdomainrelay/hono-factory-atproto-repo — Deno KV storage backend
//
// Wraps Deno.openKv() behind the Storage interface.
// Keys: ["blocks", cid] for blocks, ["heads", did] for repo heads.
// Guarded: throws a descriptive error if Deno.openKv is not available.
